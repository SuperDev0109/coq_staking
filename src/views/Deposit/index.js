...
const Deposit = ({ contract, accounts, web3, setOpen }) => {
    ...
    useEffect(() => {
        (async () => {
            ...
            console.log('tarifs', tarifs.percent);
        ...
        <div id="deposit">
            ...
            <div className="container-calculate-info">
                <div className="deposit-info">
                    <div className="period">
                        ...
                        <RangeSlider
                            ...
                            style={{ width: "80%", marginTop: "15px", height: "20px" }}
                        />
                    </div>
                ...
                <div className="deposit-result">
                    ...
                    <span>In {period} days you will earn: <b className="pink-text">{tarifs / 100 * value} COQ</b></span>
                </div>
                <div style={{ textAlign: 'center' }}>
